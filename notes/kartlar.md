...
**S:** `[zayıf]` HS256'nın çok servisli mimarideki sınırı nedir? (2026-09-16: BCrypt/encryption/signature üçü birbirine karıştı — "parola şifreleme" dendi, asıl sınır olan "doğrulama=üretme" hiç bahsedilmedi; 2026-09-19 tekrar turunda doğru geldi — "secret'ı olan mühür basabilir, RS256'da basma yetkisi tek serviste" — 1/2)
...
**S:** "Token üretme yetkisi" ile "token'ın amacı dışında başka serviste kullanılması" aynı problem mi?
