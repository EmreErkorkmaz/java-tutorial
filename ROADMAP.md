...
- [ ] **9.4 System design mock mülakatları.** Yapılanlar: URL kısaltıcı, chat sistemi (2026-09-17), flash sale (2026-09-19, yarım). Flash sale'de kalan: 10 dk rezervasyonun süresi dolunca stoğun geri dönmesi, Redis sayacı ile DB'nin birbirinden kopması, 199.000 kişilik ret yolunun anlatımda yer alması. Sonraki oturum bu kısımdan devam eder, teach-back'te zayıf kalan check-then-act kartıyla açılır.
